...
speed_boost_cost = 3  # Cost of speed boost in coins
...
while True:
    ...
    if game_state == "Selection":
        ...
        # Optionally, display character buttons here
        # You can add code to display and highlight selected characters
        ...
        # Display Shop screen
        frame = background_selection_screen.copy()  # You can use a different background for the shop
        display_text(frame, "Shop", (width//2 - 100, 100), 2, (255, 215, 0), 3)
        display_text(frame, "Press 'S' to buy Speed Boost (3 coins)", (200, 300), 1, (255, 255, 255), 2)
        ...
        if game_over:
            ...
            color = (0, 255, 0) if current_game_state == "Greenlight" else (0, 0, 255)
            display_text(frame, current_game_state, (50, 50), 2, color, 3)
            ...
            if movement_detected:
                if current_game_state == "Redlight":
                    ...
                    growth_rate = 0.0005 if speed_boost_active else 0.02
