...
bg_image = cv2.imread('Resources/Menu/BG_Play.jpg')
...
while True:
    ...
    # Shop state
        ...
        if game_over:
            if win:
                pygame.mixer.Sound.play(you_win_sound)  # Play win sound
                ...
                cv2.imshow(window_name, frame)
                pygame.mixer.Sound.play(you_lose_sound)  # Play game over sound
